 ...
 *     修改内容时必须保留山外科技的版权声明。
 *
 * @file       vcan_port_cfg.h
 * @brief      山外K60 复用管脚配置
 * @author     山外科技
 * @version    v5.0
 * @date       2013-06-26
 */
#ifndef _VCAN_DRIVERS_CFG_H_
#define _VCAN_DRIVERS_CFG_H_
...
#define TPM_CLKIN0_PIN  PTE16       //PTA18、PTB16、PTC12、PTE16、PTE29     PTA18不要用 （与晶振冲突）
